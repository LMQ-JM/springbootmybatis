...
public interface RecruitMapper {
     ...
     */
    @Select("select a.*,b.user_name,b.head_portrait,b.corporate_name from tb_recruit a INNER JOIN tb_recruiting_users b on a.user_id=b.id where a.is_delete=1 ${orderBys} ${pagings}")
    List<RecruitVo> selectAllRecruit(@Param("pagings") String pagings,@Param("orderBys") String orderBys);
