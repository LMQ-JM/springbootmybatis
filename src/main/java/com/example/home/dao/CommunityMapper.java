...
public interface CommunityMapper {
     ...
     * @return
     */
    @Select("select count(*) from tb_community_user where community_id=${id} and type=0")
     ...
     * @return
     */
    @Select("select b.avatar from  tb_community_user a INNER JOIN tb_user b on a.user_id=b.id where a.community_id=${id} and a.type=0")
