...
public interface UserMapper {
     ...
     * @return
     */
    @Select("select a.* from tb_user a inner join tb_user_gold_coins b on a.id=b.user_id where open_id=#{openId}")
     ...
     * @return
     */
    @Select("select a.*,b.can_withdraw_gold_coins,b.may_not_withdraw_gold_coins from tb_user a inner join tb_user_gold_coins b on a.id=b.user_id where a.id=${Id}")
