...
public interface UserMapper {
     ...
     * @return
     */
    @Select("select a.id,a.user_name,a.user_sex,a.avatar,a.introduce,open_id from tb_user a inner join tb_user_gold_coins b on a.id=b.user_id where open_id=#{openId}")
